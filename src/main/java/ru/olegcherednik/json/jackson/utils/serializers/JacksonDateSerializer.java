...
public class JacksonDateSerializer extends DateSerializer {
    ...
    @Override
    public void _serializeAsString(Date value, JsonGenerator generator, SerializerProvider serializers)
            throws IOException {
        delegate.serialize(value.toInstant(), generator, serializers);
    }
