 ...
 */
@Test
public class InputStreamJsonUtilsTest {

    public void shouldRetrieveNullWhenObjectNull() {
        assertThat(JsonUtils.readValue((InputStream)null, Object.class)).isNull();
        assertThat(JsonUtils.readList((InputStream)null, Object.class)).isNull();
        assertThat(JsonUtils.readListLazy(null, Object.class)).isNull();
        assertThat(JsonUtils.readMap((InputStream)null)).isNull();
        assertThat(JsonUtils.readMap((InputStream)null, String.class, String.class)).isNull();
    }

    public void shouldRetrieveMapWhenReadInputStreamAsMap() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/book.json")) {
            ...
            Map<String, ?> actual = JsonUtils.readMap(in);
    ...
    public void shouldRetrieveDeserializedObjectWhenReadInputStreamAsCustomType() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/book.json")) {
            ...
            Book actual = JsonUtils.readValue(in, Book.class);
            assertThat(actual).isNotNull();
            assertThat(actual).isEqualTo(expected);
        }
    }
    ...
    public void shouldRetrieveDeserializedListOfObjectsWhenReadInputStreamAsListWithCustomType() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/books.json")) {
            ...
            List<Book> actual = JsonUtils.readList(in, Book.class);
            assertThat(actual).isNotNull();
            assertThat(actual).isEqualTo(expected);
        }
    }
    ...
    public void shouldRetrieveDeserializedMapWhenReadInputStreamAsMapListWithStringKeyAndCustomType() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/books_dict_string_key.json")) {
            ...
            Map<String, Book> actual = JsonUtils.readMap(in, Book.class);
            assertThat(actual).isNotNull();
            assertThat(actual).isEqualTo(expected);
        }
    }
    ...
    public void shouldRetrieveDeserializedMapWhenReadInputStreamAsMapListWithIntegerKeyAndCustomType() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/books_dict_int_key.json")) {
            ...
            Map<Integer, Book> actual = JsonUtils.readMap(in, Integer.class, Book.class);
            assertThat(actual).isNotNull();
            assertThat(actual).isEqualTo(expected);
        }
    }
    ...
    public void shouldRetrieveIteratorOfDeserializedObjectsWhenReadInputStreamAsLazyList() throws IOException {
        try (InputStream in = InputStreamJsonUtilsTest.class.getResourceAsStream("/books.json")) {
            ...
            Iterator<Book> it = JsonUtils.readListLazy(in, Book.class);
