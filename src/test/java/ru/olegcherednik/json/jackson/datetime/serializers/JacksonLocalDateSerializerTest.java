...
public class JacksonLocalDateSerializerTest {
    ...
    public void shouldUserSuperClassLogicWhenDateFormatIsNull() throws JsonProcessingException {
        ...
        module.addSerializer(LocalDate.class, JacksonLocalDateSerializer.INSTANCE);

        ObjectMapper mapper = new ObjectMapper().registerModule(module);
        String json = mapper.writeValueAsString(LocalDate.parse("2017-07-23"));
        assertThat(json).isEqualTo("[2017,7,23]");
    }
