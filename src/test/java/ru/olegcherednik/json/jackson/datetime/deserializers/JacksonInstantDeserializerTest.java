...
public class JacksonInstantDeserializerTest {
    ...
    public void shouldApplyLenientWhenDeserializeWithContextFormatter() throws JsonProcessingException {
        ...
        Data actual = mapper.readValue(json, Data.class);
    ...
    public void shouldNotCreateNewInstanceWhenUseSameDataTimeFormat() {
        LocalJacksonInstantDeserializer deser = new LocalJacksonInstantDeserializer(DateTimeFormatter.ISO_INSTANT);
    ...
    private static final class LocalJacksonInstantDeserializer extends JacksonInstantDeserializer {

        private static final long serialVersionUID = 1561269843027654505L;

        private LocalJacksonInstantDeserializer(DateTimeFormatter df) {
            super(df);
        }
